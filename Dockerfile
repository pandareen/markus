...
RUN cd /data/Swagger/ && mkdir build && cd build && CC="clang" CXX="clang++" cmake -DCMAKE_PREFIX_PATH=/usr/lib/llvm-10 -DCMAKE_EXPORT_COMPILE_COMMANDS=ON .. && cd .. && iwyu_tool.py -p compile_commands.json .
